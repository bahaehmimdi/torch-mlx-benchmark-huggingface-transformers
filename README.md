...
# huggingface/transformers — Benchmark torch-mlx sur Mac

Résultats de test de **torch-mlx** (API PyTorch basée sur le moteur **MLX**
d'Apple Silicon) appliqués à **huggingface/transformers**.

**Statut : OK — GPT2 testé**
...
transformers / GPT2. 13 vrais gaps (round 343) sur l'API transformers (constructeurs de modules, attention, config).
